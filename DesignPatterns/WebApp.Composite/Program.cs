    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (!userManager.Users.Any())
            {
                ...
                var newSubCategory1 = new Category() { Name = "Cinayet Romanlarý 1", ReferenceId = newCategory2.Id, UserId = newUser.Id };
                var newSubCategory2 = new Category() { Name = "Suç Romanlarý 1", ReferenceId = newCategory1.Id, UserId = newUser.Id };
                var newSubCategory3 = new Category() { Name = "Polisiye Romanlarý 1", ReferenceId = newCategory3.Id, UserId = newUser.Id };
                identityDbContext.Categories.AddRange(newSubCategory1,newSubCategory2,newSubCategory3);
                identityDbContext.SaveChanges();

                var newSubCategory4 = new Category() { Name = "Cinayet Romanlarý 1.1", ReferenceId = newSubCategory1.Id, UserId = newUser.Id };
